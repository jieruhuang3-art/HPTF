...
from hptf.uer.layers.position_ffn import PositionwiseFeedForward, GatedFeedForward
from hptf.uer.layers.multi_headed_attn import MultiHeadedAttention
...
class TransformerLayer(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.self_attn = MultiHeadedAttention(
            ...
            use_rope=getattr(args, "rope_position_embedding", False),
