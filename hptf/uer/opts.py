def model_opts(parser):
    ...
    parser.add_argument("--rope_position_embedding", action="store_true",
                        help="Use rotary position embedding (RoPE) inside self-attention.")
    parser.add_argument("--rope_base", type=float, default=10000.0,
                        help="Base frequency used by rotary position embedding.")
...
def finetune_opts(parser):
    ...
    parser.add_argument("--config_path", default="bert_base_config.json", type=str,
