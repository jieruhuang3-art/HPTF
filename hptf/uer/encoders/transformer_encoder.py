...
from hptf.uer.layers.transformer import TransformerLayer
from hptf.uer.layers.layer_norm import LayerNorm, T5LayerNorm
from hptf.uer.layers.relative_position_embedding import RelativePositionEmbedding
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.rope_position_embedding = getattr(args, "rope_position_embedding", False)
        ...
        if self.relative_position_embedding and not self.rope_position_embedding:
    ...
    def forward(self, emb, seg, **kwargs):
        """
        Args:
